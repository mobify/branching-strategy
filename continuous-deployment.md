...
| feature | NO          | YES              | `master`         | Cutting-edge features (**unstable**). These branches are used for any maintenance features / active development. |
| `hotfix-*` | NO       | YES              | `master`         | These are bug fixes against production.<br/> |
